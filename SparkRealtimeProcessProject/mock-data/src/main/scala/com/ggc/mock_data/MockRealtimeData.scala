package com.ggc.mock_data

import java.util.Properties

import com.ggc.mock_data.bean.CityInfo
import com.ggc.mock_data.util.{RandomNumUtil, RandomOptions}
...
object MockRealtimeData {
  ...
  def createKafkaProducer: KafkaProducer[String, String] = {
    ...
    // Kafka服务端的主机名和端口号
    props.put("bootstrap.servers", "dw1:9092,dw2:9092,dw3:9092")
    // key序列化
